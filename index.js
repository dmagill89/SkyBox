...
function loadSkyBox() {
		...
		var materials = [
			createMaterial( 'img/right.png' ), // right
			createMaterial( 'img/left.png' ), // left
			createMaterial( 'img/top.png' ), // top
			createMaterial( 'img/bottom.png' ), // bottom
			createMaterial( 'img/back.png' ), // back
			createMaterial( 'img/front.png' )  // front
		];
